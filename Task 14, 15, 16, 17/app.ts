// TASK 14         GUEST LIST
let guest :string [] = ['Samia','Maria','Nazia','Wajiha'];
for(let value of guest){console.log(`\n Dear ${value}, \n\n I would like to invite you at dinner party today. Please come and join us.\n\n Thankyou !\n`);}
...
while(guest.length>2){let removedGuest = guest.pop() ;
     console.log(`Sorry, ${removedGuest} I can't invite you at dinner party.`);}
for (let value of guest)(console.log(`Dear ${value}, You're still invited at dinner party.`))
guest.length= 0;
console.log(guest);